...
# Cuenta los commits por día y por autor, y selecciona los últimos 7 días
commits_per_day_author = df.groupby([df['date'].dt.date, 'author']).size().unstack(fill_value=0).tail(7)
